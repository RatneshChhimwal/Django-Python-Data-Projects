with open("Use-Lecture-38.txt",'r') as f:
    f.seek(10)
    m=f.read(5)
    print(m)
...
with open('Use-Lecture-38.txt', 'r') as f:
  ...
  current_position = f.tell()        # Stores the value of bytes argument of the seek() function
...
with open('Use-Lecture-38.txt', 'w') as f:
  f.write('Hello World!')

  f.truncate(5)             # We have truncated down the number of characters to be stored in the txt file
