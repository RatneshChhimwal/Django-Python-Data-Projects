...
Below we have the examples for shutil module and its various functions and how they can be used in Python.

"""

import shutil

# shutil.copy("Walrus Operator (Lecture-63).py", "Shutil module (Lecture-64).py")

source = r"C:\Users\ratne\Desktop\New folder\cloud.png"
destination = r"C:\Users\ratne\Desktop\CopiedWithShutilModule.png"
